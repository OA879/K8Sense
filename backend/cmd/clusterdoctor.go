...
func setupClusterDoctor(r *mux.Router, config *HeadlampConfig) {
	...
	r.HandleFunc("/cluster-doctor/branding", cdServer.GetBranding).Methods("GET")
	r.HandleFunc("/cluster-doctor/branding", cdServer.SetBranding).Methods("PUT")
	r.HandleFunc("/cluster-doctor/role", cdServer.GetRole).Methods("GET")
	r.HandleFunc("/cluster-doctor/role", cdServer.SetRole).Methods("PUT")
