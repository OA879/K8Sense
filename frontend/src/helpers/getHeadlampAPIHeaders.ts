 ...
 *
 * The app also sets K8SENSE_BACKEND_TOKEN in the k8sense-server environment,
 ...
 * the token can be initialized from the REACT_APP_K8SENSE_BACKEND_TOKEN
 * environment variable to authenticate API requests.
 */
let backendToken: string | null = import.meta.env.REACT_APP_K8SENSE_BACKEND_TOKEN || null;
...
export function setBackendToken(token: string | null) {
  backendToken = import.meta.env.REACT_APP_K8SENSE_BACKEND_TOKEN || token;
}
