...
export function getVersion() {
  return {
    VERSION: import.meta.env.REACT_APP_K8SENSE_VERSION,
    GIT_VERSION: import.meta.env.REACT_APP_K8SENSE_GIT_VERSION,
  };
}
/**
...
export function getProductName(): string | undefined {
  return import.meta.env.REACT_APP_K8SENSE_PRODUCT_NAME;
}
