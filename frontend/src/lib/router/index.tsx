...
import CatalogPage from '../../pages/cluster-doctor/CatalogPage';
...
const defaultRoutes: { [routeName: string]: Route } = {
  ...
  clusterDoctorHistory: {
    path: '/cluster-doctor/history',
    name: 'Scan History',
    exact: true,
    sidebar: { item: 'clusterDoctorHistory', sidebar: DefaultSidebars.IN_CLUSTER },
  ...
  clusterDoctorRules: {
    ...
    name: 'Rule Library',
    exact: true,
    sidebar: { item: 'clusterDoctorRules', sidebar: DefaultSidebars.IN_CLUSTER },
    component: () => <RulesPage />,
  },
  clusterDoctorNetworkMap: {
    ...
    name: 'Network Map',
    exact: true,
    sidebar: { item: 'clusterDoctorNetworkMap', sidebar: DefaultSidebars.IN_CLUSTER },
  ...
  clusterDoctorTimeline: {
    ...
    name: 'What changed?',
    exact: true,
    sidebar: { item: 'clusterDoctorTimeline', sidebar: DefaultSidebars.IN_CLUSTER },
  ...
  clusterDoctorCost: {
    ...
    name: 'Cost & Waste',
    exact: true,
    sidebar: { item: 'clusterDoctorCost', sidebar: DefaultSidebars.IN_CLUSTER },
    component: () => <CostPage />,
  },
  clusterDoctorUpgrade: {
    ...
    exact: true,
    sidebar: { item: 'clusterDoctorUpgrade', sidebar: DefaultSidebars.IN_CLUSTER },
    component: () => <UpgradePage />,
  },
  clusterDoctorCatalog: {
    path: '/cluster-doctor/catalog',
    name: 'App Catalog',
    exact: true,
    sidebar: { item: 'clusterDoctorCatalog', sidebar: DefaultSidebars.IN_CLUSTER },
    component: () => <CatalogPage />,
  },
  clusterDoctorRunbooks: {
    path: '/cluster-doctor/runbooks',
    name: 'Runbooks',
    exact: true,
    sidebar: { item: 'clusterDoctorRunbooks', sidebar: DefaultSidebars.IN_CLUSTER },
  ...
  clusterDoctorCopilot: {
    ...
    name: 'Copilot',
    exact: true,
    sidebar: { item: 'clusterDoctorCopilot', sidebar: DefaultSidebars.IN_CLUSTER },
  ...
  clusterDoctorVulnScan: {
    ...
    exact: true,
    sidebar: { item: 'clusterDoctorVulnScan', sidebar: DefaultSidebars.IN_CLUSTER },
  ...
  clusterDoctorCompliance: {
    ...
    exact: true,
    sidebar: { item: 'clusterDoctorCompliance', sidebar: DefaultSidebars.IN_CLUSTER },
  ...
  clusterDoctorAuditLog: {
    ...
    name: 'Audit Log',
    exact: true,
    sidebar: { item: 'clusterDoctorAuditLog', sidebar: DefaultSidebars.IN_CLUSTER },
  ...
  clusterDoctorSettings: {
    ...
    exact: true,
    sidebar: { item: 'clusterDoctorSettings', sidebar: DefaultSidebars.IN_CLUSTER },
  ...
  clusterDoctorMultiScan: {
    ...
    exact: true,
    sidebar: { item: 'clusterDoctorMultiScan', sidebar: DefaultSidebars.IN_CLUSTER },
