    ...
    config.plugins?.push(
      new webpack.DefinePlugin({
        'import.meta.env': JSON.stringify({
          ...
          REACT_APP_K8SENSE_ENABLE_ROW_SELECTION:
            process.env.REACT_APP_K8SENSE_ENABLE_ROW_SELECTION,
          ...
          REACT_APP_K8SENSE_BACKEND_TOKEN: process.env.REACT_APP_K8SENSE_BACKEND_TOKEN,
          PUBLIC_URL: process.env.PUBLIC_URL,
          REACT_APP_K8SENSE_VERSION: process.env.REACT_APP_K8SENSE_VERSION,
          REACT_APP_K8SENSE_GIT_VERSION: process.env.REACT_APP_K8SENSE_GIT_VERSION,
          REACT_APP_K8SENSE_PRODUCT_NAME: process.env.REACT_APP_K8SENSE_PRODUCT_NAME,
        }),
      })
    );
